# Figure 6. GLM example data

Example data resulting from GLM modeling is shown here in GLM\_eg\_data.npy   
GLM\_eg\_data.npy is a numpy python dictionary. here is an example of a single neuron fitted to a GLM model using parameters described in the manuscript.   
...
* init\_score: initial r2 fitting score for each task variable
